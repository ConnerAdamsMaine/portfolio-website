...
<SeoHead title={formatTitle('Resume Upload')} description="Upload and manage your resume PDF." />

<section class="section-pad">
	<div class="space-y-4">
		<p class="badge">Admin</p>
		<h1 class="text-4xl font-semibold text-white sm:text-5xl">Resume</h1>
		<p class="max-w-2xl text-lg text-ink-200">Upload and manage your PDF resume.</p>
		<AdminNav />
	</div>
</section>
...
<section class="section-pad">
	<div class="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
		<MotionReveal className="space-y-5">
			...
			<p class="text-sm text-ink-200">Replace the current resume PDF.</p>
			{#if data.resume}
